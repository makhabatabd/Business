...
if (!document.querySelector(".navigation")) {
  var undoName = function undoName() {
    span_name.style.display = "none";
    name.style.border = "1px solid #282C37";
  };

  var undoEmail = function undoEmail() {
  ...
  var modal = document.querySelector(".modal__outter");
  ...
  var span_name = document.querySelector(".name__span");
  var span_email = document.querySelector(".email__span");
  var span_text = document.querySelector(".text__span");
  var close = document.getElementById("close");
  var send = document.querySelector(".send__button");
  var form = document.getElementById("form");
  var dot = document.getElementById("loading__dots");
  var open = document.getElementById("modal__open");
  ...
  send.addEventListener("click", function (e) {
    ...
    if (name.value.length > 3 && email.value.length > 3 && text.value.length > 3) {
  ...
  var removeSpans = function removeSpans() {
    span_name.style.display = "none";
    span_email.style.display = "none";
    span_text.style.display = "none";
  };
...
if (document.querySelector(".plan") || document.querySelector(".info")) {
  ...
  name.addEventListener("input", function () {
    name.value === "" ? name.style.border = "1px solid #CF4747" : name.style.border = "1px solid #9FA7B0";
  });
  email.addEventListener("input", function () {
    email.value.match(validRegex) ? email.style.border = "1px solid #9FA7B0" : email.style.border = "1px solid #CF4747";
  });
}
...
// EXTERNAL MODULE: ./src/js/validation.js
var validation = __webpack_require__(440);
// EXTERNAL MODULE: ./src/js/modal.js
var modal = __webpack_require__(6862);
// EXTERNAL MODULE: ./src/js/link.js
var js_link = __webpack_require__(2096);
